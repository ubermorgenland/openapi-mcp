...
//
//	hooks := &Hooks{
//		BeforeRequest: func(ctx context.Context, req *mcp.JSONRPCRequest) context.Context {
//			log.Printf("Received request: %s", req.Method)
//			return ctx
//		},
//		AfterRequest: func(ctx context.Context, req *mcp.JSONRPCRequest, resp *mcp.JSONRPCResponse) {
//			log.Printf("Completed request: %s", req.Method)
//		},
//	}
//	server := NewMCPServer("myserver", "1.0.0", WithHooks(hooks))
